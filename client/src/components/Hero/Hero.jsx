...
import cartel from "../../assets/cartelafuera.png";
...
const Hero = () => {
  ...
  return (
    <div id="inicio" style={bgStyle}>
      <div className="min-h-[650px] md:min-h-[750px] bg-gradient-to-r from-black/70 to-[#c9b35271] pt-32 pb-24
 md:pt-48">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 text-white">
            ...
            >
              ...
              <a
                ...
                className="block text-center bg-[#c9b452] text-white font-semibold py-2 px-4 w-full rounded-full mt-4 hover:bg-[#1b1b1a] transition-all"
              >
                Enviar por WhatsApp
              </a>
            </motion.div>

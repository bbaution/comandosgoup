  ...
  return (
    <>
      <div
        ...
        } h-screen w-[75%] bg-[#111110] dark:bg-slate-950 dark:text-white z-50 transition-all duration-500 pt-10 pb-6 px-8 flex flex-col justify-between md:hidden`}
      >
        {/* Navbar section */}
        ...
        {/* Nav Footer section */}
        <div className="border-t border-gray-300/50 pt-6 text-center text-sm text-white">
